...
export class JellyShader : public VertFragTessShader
{
public:
    JellyShader() : VertFragTessShader("shaders/jelly.vert", "shaders/phong.frag", "shaders/jelly.tesc", "shaders/jelly.tese") {}
};